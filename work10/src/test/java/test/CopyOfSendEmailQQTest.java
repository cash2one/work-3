...
public class CopyOfSendEmailQQTest {
    ...
    public static void main(String[] args) throws MessagingException, IOException
    {
       ...
       //  CopyOfSendEmailQQTest mail = new CopyOfSendEmailQQTest("1512018642@qq.com","dsuicktamukpecig");
        ...
        list.add("778024689@qq.com");
 
      
        for(String str:list){
            mimeMessage.addRecipient(Message.RecipientType.TO, new InternetAddress(str));
        }
        mimeMessage.setSubject("测试邮箱");
 
        mimeMessage.setSentDate(new Date());
        
 
        mimeMessage.setFrom(new InternetAddress("1512018642@qq.com"));
        ...
        bodypart.setContent("谢谢合作,欢迎下次继续合作", "text/html; charset=UTF-8");
     ...
     * @param password
     */
    public CopyOfSendEmailQQTest(String username,String password){
  ...
  /*  public void initMessage(){
     ...
     */
    public void setDefaultMessageproperties(String sub,String text,String rec) throws MessagingException, UnsupportedEncodingException{
